...
def apply_migration() -> None:
    ...
    sql_path = backend_dir / "database" / "004_employee_feedbacks.sql"
...
def notify_postgrest_schema_reload() -> None:
    backend_dir = Path(__file__).resolve().parents[1]
    load_dotenv(backend_dir / ".env")
...
def main() -> None:
    ...
    print("004_employee_feedbacks migration applied successfully")
