  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const mapped: SentimentResult = {
        ...
        sarcasm_detected: Boolean(payload?.sarcasm_detected),
        sarcasm_confidence: typeof payload?.sarcasm_confidence === 'number' ? payload.sarcasm_confidence : 0,
        sarcasm_adjusted_polarity: typeof payload?.sarcasm_adjusted_polarity === 'number' ? payload.sarcasm_adjusted_polarity : (typeof payload.score === 'number' ? payload.score : 0),
